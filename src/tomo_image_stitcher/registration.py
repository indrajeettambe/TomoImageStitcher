...
try:
    ...
    binary_erosion_cp = None  # type: ignore[assignment]
    affine_transform_cp = None  # type: ignore[assignment]
    gaussian_filter_cp = None  # type: ignore[assignment]
    shift_transform_cp = None  # type: ignore[assignment]
    correlate = None  # type: ignore[assignment]
...
class RegistrationKIT:
    ...
    def lucas_kanade_3D_inv_mask(template_img,
        ...
        if isinstance(slice_extract, int):
